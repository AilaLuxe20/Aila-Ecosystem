            ...
            <div className="space-y-6">
                <div className="rounded-xl border border-white/[0.08] bg-white/[0.025] p-8">
                    <h2 className="text-2xl font-semibold text-white">
                        Aila UI/UX — Foundation Ready
                    </h2>
                    <p className="mt-3 max-w-2xl text-neutral-400">
                        The platform foundation for Aila UI/UX has been registered.
                ...
                <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                    {[
                        { label: "Design System", status: "Planned" },
                        { label: "Component Library", status: "Planned" },
                        { label: "Adaptive Layout", status: "Planned" },
                        { label: "Prototyping", status: "Planned" },
                        { label: "Accessibility", status: "Planned" },
                        { label: "Design Tokens", status: "Planned" },
                    ].map((item) => (
                        <div
                            key={item.label}
