...
const capabilities = [
  {
    ...
    description:
      "Turn rough ideas into clearer product concepts, features, and development directions.",
  },
  {
    number: "02",
    title: "AI Guidance",
  ...
  },
  {
    ...
    description:
      "Connect you with Aila Legal, Business, Automation, Ads, and the other signed-in workspaces.",
  },
];
      ...
      <section className="relative mx-auto grid max-w-7xl gap-16 px-6 pb-24 pt-24 lg:grid-cols-[0.9fr_1.1fr] lg:items-center lg:min-h-[calc(100vh-8rem)]">
        <div>
          ...
          <p className="mt-8 max-w-xl text-lg leading-8 text-neutral-400">
            Chat with Aila, attach files to a conversation, and keep history on
            your account. Sign in to send a message.
          </p>
      ...
      <section className="relative mx-auto max-w-7xl px-6 py-28">
        <div className="text-center">
          ...
          <h2 className="mx-auto mt-6 max-w-4xl text-4xl font-semibold tracking-[-0.05em] sm:text-6xl">
            One core.
            <span className="block text-neutral-600">Multiple workspaces.</span>
          </h2>
        </div>
        ...
        <div className="mt-16 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {ecosystemNodes.map((node) => (
            ...
            >
              ...
              <h3 className="mt-12 text-xl font-medium">{node.title}</h3>
              <p className="mt-3 text-sm text-neutral-600">{node.description}</p>
            </Link>
          ))}
        </div>
      </section>
        ...
        <div className="grid gap-12 lg:grid-cols-[0.8fr_1.2fr]">
          <div>
            ...
            <h2 className="mt-6 max-w-lg text-4xl font-semibold tracking-[-0.05em] sm:text-6xl">
              Start with an idea.
              <span className="block text-neutral-600">Build what comes next.</span>
            </h2>
            <p className="mt-7 max-w-md leading-8 text-neutral-500">
              Aila helps turn ideas into clearer products, software, and
              automation — then routes you into the workspace that stores the work.
            </p>
          </div>
        ...
        <div className="relative overflow-hidden rounded-[40px] border border-white/[0.09] bg-white/[0.025] px-6 py-20 text-center backdrop-blur-2xl sm:px-12">
          ...
          <div className="relative">
            ...
            <h2 className="mx-auto mt-6 max-w-4xl text-4xl font-semibold tracking-[-0.05em] sm:text-6xl">
              ...
              <span className="block text-neutral-600">a real product.</span>
            </h2>
            <p className="mx-auto mt-7 max-w-xl leading-8 text-neutral-400">
              Tell Aila what you want to create, or use the project form if you
              want Aila Luxe to build it with you.
            </p>
            <Link
              href="/#start-project"
